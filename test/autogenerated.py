...
class TestEverything(unittest.TestCase):
    ...
    def test_averageWeighted(self):
        ...
        self.assertEqual(ed(x), ed(pickle.loads(pickle.dumps(x))))
        x.fill(Struct(True, -2, 3.4, 'one'))
        self.assertAlmostEqualJSON(x.toJson(), {'data': {'data': {'entries': 0.0, 'mean': 'nan'}, 'type': 'Average', 'entries': 1}, 'type': 'Select'})
        self.assertEqual(x, x)
        self.assertEqual(ed(x), ed(x))
        self.assertEqual(hash(x), hash(x))
        self.assertEqual(hash(ed(x)), hash(ed(x)))
        ...
        self.assertEqual(ed(x), ed(pickle.loads(pickle.dumps(x))))
        x.fill(Struct(False, -1, 2.2, 'two'))
        self.assertAlmostEqualJSON(x.toJson(), {'data': {'data': {'entries': 0.0, 'mean': 'nan'}, 'type': 'Average', 'entries': 2}, 'type': 'Select'})
        self.assertEqual(x, x)
        self.assertEqual(ed(x), ed(x))
        self.assertEqual(hash(x), hash(x))
        self.assertEqual(hash(ed(x)), hash(ed(x)))
        ...
        self.assertEqual(ed(x), ed(pickle.loads(pickle.dumps(x))))
        x.fill(Struct(True, 0, -1.8, 'three'))
        self.assertAlmostEqualJSON(x.toJson(), {'data': {'data': {'entries': 0.0, 'mean': 'nan'}, 'type': 'Average', 'entries': 3}, 'type': 'Select'})
        self.assertEqual(x, x)
        self.assertEqual(ed(x), ed(x))
        self.assertEqual(hash(x), hash(x))
        self.assertEqual(hash(ed(x)), hash(ed(x)))
    ...
    def test_deviateWeighted(self):
        ...
        self.assertEqual(ed(x), ed(pickle.loads(pickle.dumps(x))))
        x.fill(Struct(True, -2, 3.4, 'one'))
        self.assertAlmostEqualJSON(x.toJson(), {'data': {'data': {'variance': 'nan', 'mean': 'nan', 'entries': 0.0}, 'type': 'Deviate', 'entries': 1}, 'type': 'Select'})
        self.assertEqual(x, x)
        self.assertEqual(ed(x), ed(x))
        self.assertEqual(hash(x), hash(x))
        self.assertEqual(hash(ed(x)), hash(ed(x)))
        ...
        self.assertEqual(ed(x), ed(pickle.loads(pickle.dumps(x))))
        x.fill(Struct(False, -1, 2.2, 'two'))
        self.assertAlmostEqualJSON(x.toJson(), {'data': {'data': {'variance': 'nan', 'mean': 'nan', 'entries': 0.0}, 'type': 'Deviate', 'entries': 2}, 'type': 'Select'})
        self.assertEqual(x, x)
        self.assertEqual(ed(x), ed(x))
        self.assertEqual(hash(x), hash(x))
        self.assertEqual(hash(ed(x)), hash(ed(x)))
        ...
        self.assertEqual(ed(x), ed(pickle.loads(pickle.dumps(x))))
        x.fill(Struct(True, 0, -1.8, 'three'))
        self.assertAlmostEqualJSON(x.toJson(), {'data': {'data': {'variance': 'nan', 'mean': 'nan', 'entries': 0.0}, 'type': 'Deviate', 'entries': 3}, 'type': 'Select'})
        self.assertEqual(x, x)
        self.assertEqual(ed(x), ed(x))
        self.assertEqual(hash(x), hash(x))
        self.assertEqual(hash(ed(x)), hash(ed(x)))
