...
class TestNumpy(unittest.TestCase):
    ...
    def testBag(self):
        with Numpy() as numpy:
            if numpy is None: return
            sys.stderr.write("\n")
            self.compare("Bag no data", Bag(lambda x: x["empty"], "N"), self.data, Bag(lambda x: x, "N"), self.empty, 1.0)
            self.compare("Bag noholes w/o weights", Bag(lambda x: x["noholes"], "N"), self.data, Bag(lambda x: x, "N"), self.noholes, 1.0)
            self.compare("Bag noholes const weights", Bag(lambda x: x["noholes"], "N"), self.data, Bag(lambda x: x, "N"), self.noholes, 0.5)
            self.compare("Bag noholes positive weights", Bag(lambda x: x["noholes"], "N"), self.data, Bag(lambda x: x, "N"), self.noholes, self.positive)
            self.compare("Bag noholes with weights", Bag(lambda x: x["noholes"], "N"), self.data, Bag(lambda x: x, "N"), self.noholes, self.noholes)
            self.compare("Bag noholes with holes", Bag(lambda x: x["noholes"], "N"), self.data, Bag(lambda x: x, "N"), self.noholes, self.withholes)
            self.compare("Bag holes w/o weights", Bag(lambda x: x["withholes"], "N"), self.data, Bag(lambda x: x, "N"), self.withholes, 1.0)
            self.compare("Bag holes const weights", Bag(lambda x: x["withholes"], "N"), self.data, Bag(lambda x: x, "N"), self.withholes, 0.5)
            self.compare("Bag holes positive weights", Bag(lambda x: x["withholes"], "N"), self.data, Bag(lambda x: x, "N"), self.withholes, self.positive)
            self.compare("Bag holes with weights", Bag(lambda x: x["withholes"], "N"), self.data, Bag(lambda x: x, "N"), self.withholes, self.noholes)
            self.compare("Bag holes with holes", Bag(lambda x: x["withholes"], "N"), self.data, Bag(lambda x: x, "N"), self.withholes, self.withholes)
            self.compare("Bag holes with holes2", Bag(lambda x: x["withholes"], "N"), self.data, Bag(lambda x: x, "N"), self.withholes, self.withholes2)
