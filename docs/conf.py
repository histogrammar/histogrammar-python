...
project = u'Histogrammar'
copyright = u'2016, DIANA-HEP'
...
htmlhelp_basename = 'Histogrammardoc'
...
latex_documents = [
  ('index', 'Histogrammar.tex', u'Histogrammar Documentation',
   u'DIANA-HEP', 'manual'),
]
...
man_pages = [
    ('index', 'histogrammar', u'Histogrammar Documentation',
     [u'DIANA-HEP'], 1)
]
...
texinfo_documents = [
  ('index', 'Histogrammar', u'Histogrammar Documentation',
   u'DIANA-HEP', 'Histogrammar', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_title = u'Histogrammar'
epub_author = u'DIANA-HEP'
epub_publisher = u'DIANA-HEP'
epub_copyright = u'2016, DIANA-HEP'
