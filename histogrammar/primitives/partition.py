...
class Partition(Factory, Container):
    ...
    def __eq__(self, other):
        return isinstance(other, Partition) and exact(self.entries, other.entries) and self.quantity == other.quantity and self.cuts == other.cuts and self.nanflow == other.nanflow
