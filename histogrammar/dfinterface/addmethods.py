...
from ..convenience import (
    TwoDimensionallySparselyHistogram as hg_TwoDimensionallySparselyHistogram,
)
...
def add_methods(cls, hg, prefix="hg_"):
    ...
    if inspect.isclass(cls):
        ...
        setattr(
            cls,
            prefix + "TwoDimensionallySparselyHistogram",
        ...
        setattr(
            ...
            types.MethodType(CategorizeHistogram, cls),
        )
        ...
        setattr(
            cls,
            prefix + "SparselyProfileErr",
            types.MethodType(SparselyProfileErr, cls),
        )
        setattr(
            cls,
            prefix + "TwoDimensionallyHistogram",
            types.MethodType(TwoDimensionallyHistogram, cls),
        )
        setattr(
            cls,
            prefix + "TwoDimensionallySparselyHistogram",
