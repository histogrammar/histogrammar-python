...
class TestCommand(Command):
    ...
    def run(self):
        ...
        if sys.version_info[0] == 2 and sys.version_info[1] == 6:
            args = ["-c", "import unittest; from test.original import *; from test.autogenerated import *; from test.original import *; from test.autogenerated import *; from test.testnumpy import *; unittest.main()"]
        else:
            args = ["-m", "unittest", "-v", "test.original", "test.autogenerated", "test.testnumpy"]
